...
- Encoder : 1-D convolutional layer, dilation
- Decoder : masked 1-D convolution layer, dilation
...
- Autoregressive하므로 이전 단계의 token을 다음 단계 token에 넣어줌
...
- embedding 결과를 concatenate하여 $$n \times 2d$$ tensor로 만든다.
